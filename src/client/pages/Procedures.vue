...
import { useProcedures } from '../../composables/procedure/useProcedures.js';
...
<template>
  <div class="flex flex-col w-full max-w-6xl mx-auto p-4 min-h-screen">
    <h2
      class="text-3xl self-center md:text-4xl tracking-[0.01em] font-bold mb-6 bg-[#E5A663] bg-clip-text text-transparent"
    >
      Услуги
    </h2>
